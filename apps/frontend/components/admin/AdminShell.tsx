        ...
        <header className="rounded-[28px] border border-white/10 bg-white/[0.06] p-4 shadow-[0_24px_70px_rgba(0,0,0,0.32)] backdrop-blur-xl md:p-6">
          <div className="flex flex-col gap-4 md:flex-row md:items-start md:justify-between">
            <div>
              <Link
                href="/admin"
                className="inline-flex items-center gap-2 rounded-full bg-orange-500 px-3 py-1.5 text-[12px] font-black uppercase tracking-[0.16em] text-white shadow-[0_10px_24px_rgba(249,115,22,0.22)]"
              >
