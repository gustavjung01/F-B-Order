...
export function ProductHomeTea({ active = "home", initialCatalog }: { active?: AppNavKey; initialCatalog: CatalogV2ListResponse | null }) {
  ...
  return (
    <MobilePageShell active={active} title="Bếp Sỉ F&B" subtitle={catalog.loading ? "Đang tải sản phẩm" : String(catalog.total) + " sản phẩm"}>
