...
export default function GoodsPage() {
  return (
    <ResponsivePageShell active="goods" title="Hàng" subtitle="Tính năng đang được định hình">
      <section className="rounded-[30px] border border-dashed border-[#b9eadb] bg-white/80 px-6 py-12 text-center shadow-sm">
        ...
        <p className="mx-auto mt-3 max-w-2xl text-sm font-semibold leading-7 text-slate-500">
          Hiện tại Trang chủ là nơi xem, tìm kiếm và lọc toàn bộ sản phẩm. Nhánh Hàng được giữ độc lập để phát triển thành một chức năng khác trong tương lai, nên không lặp lại catalog tại đây.
        </p>
      </section>
    </ResponsivePageShell>
  );
