...
export default function RegisterPage() {
  return (
    <MobilePageShell active="account" title="Dang ky khach si" subtitle="Admin duyet moi thay gia">
      <section className="overflow-hidden rounded-[28px] bg-[#fff1d7] p-5 shadow-[0_14px_30px_rgba(15,23,42,0.085)] ring-1 ring-white/80">
        <div className="relative min-h-[166px]">
          <div className="relative z-10 max-w-[235px]">
            ...
            <h1 className="mt-3 text-[27px] font-black leading-tight tracking-tight">Tao ho so shop de mo bang gia</h1>
            <p className="mt-3 text-[14px] font-semibold leading-6 text-slate-700">Khach le khong duoc xem gia. Admin se duyet sau khi xac minh thong tin.</p>
          </div>
      ...
      <section className="mt-4 rounded-[24px] bg-white p-4 text-[14px] font-semibold leading-6 text-slate-600 shadow-[0_12px_26px_rgba(15,23,42,0.075)] ring-1 ring-[#efe7dc]">
        <b className="text-[#0b1220]">Sau khi gui:</b> ho so se o trang thai cho duyet. Khi admin xac nhan, shop moi xem duoc gia si va gui don.
        <Link href="/account" className="mt-3 block font-black text-[#ff5a00]">Xem trang thai ho so</Link>
      </section>
    </MobilePageShell>
  );
}
